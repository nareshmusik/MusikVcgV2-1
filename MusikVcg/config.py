...
SESSION_NAME  =  getenv ( "SESSION_NAME" , "sesi" )
...
ARQ_API_KEY  =  getenv ( "ARQ_API_KEY" , Tidak Ada )

PMPERMIT  =  getenv ( "PMPERMIT" , Tidak Ada )

LOG_GRP  =  getenv ( "LOG_GRP" , Tidak Ada )

COMMAND_PREFIXES  =  daftar ( getenv ( "COMMAND_PREFIXES" , "/ !" ). split ())

SUDO_USERS  =  daftar ( peta ( int , getenv ( "SUDO_USERS" ). split ()))
